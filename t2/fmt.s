...
fmt.Sprintf: # args 72, locals -277
  ...
  cmpq $1, %rax
  jne .L.range.exit.129 # jmp if false
  ...
  popq %rax # result of  of switch-case comparison
  cmpq $1, %rax
  je .L.case.136 # jump if match
  jmp .L.case.137
  addq $1, %rsp # revert stack top
  .L.case.133:
  jmp .L.switch.132.exit
  .L.case.134:
  ...
  cmpq %rcx, %rdx
  je .L.cmpdtypes.140.true # jump if match
  cmpq $0, %rdx # check if A is nil
  je .L.cmpdtypes.140.false # jump if nil
  cmpq $0, %rcx # check if B is nil
  je .L.cmpdtypes.140.false # jump if nil
  jmp .L.cmpdtypes.140.cmp # jump to end
  .L.cmpdtypes.140.true:
  pushq $1
  jmp .L.cmpdtypes.140.end # jump to end
  .L.cmpdtypes.140.false:
  pushq $0
  jmp .L.cmpdtypes.140.end # jump to end
  .L.cmpdtypes.140.cmp:
  ...
  popq %rcx           # dtype label address B
  cmpq %rcx, %rdx
  je .L.cmpdtypes.142.true # jump if match
  cmpq $0, %rdx # check if A is nil
  je .L.cmpdtypes.142.false # jump if nil
  cmpq $0, %rcx # check if B is nil
  je .L.cmpdtypes.142.false # jump if nil
  jmp .L.cmpdtypes.142.cmp # jump to end
  .L.cmpdtypes.142.true:
  pushq $1
  jmp .L.cmpdtypes.142.end # jump to end
  .L.cmpdtypes.142.false:
  pushq $0
  jmp .L.cmpdtypes.142.end # jump to end
  .L.cmpdtypes.142.cmp:
  subq $8, %rsp # alloc return vars area
  ...
  popq %rax # result of  indexvar < lenvar
  cmpq $1, %rax
  jne .L.range.exit.144 # jmp if false
  ...
  popq %rcx           # dtype label address B
  cmpq %rcx, %rdx
  je .L.cmpdtypes.147.true # jump if match
  cmpq $0, %rdx # check if A is nil
  je .L.cmpdtypes.147.false # jump if nil
  cmpq $0, %rcx # check if B is nil
  je .L.cmpdtypes.147.false # jump if nil
  jmp .L.cmpdtypes.147.cmp # jump to end
  .L.cmpdtypes.147.true:
  pushq $1
  jmp .L.cmpdtypes.147.end # jump to end
  .L.cmpdtypes.147.false:
  pushq $0
  jmp .L.cmpdtypes.147.end # jump to end
  .L.cmpdtypes.147.cmp:
  subq $8, %rsp # alloc return vars area
  ...
  popq %rcx           # dtype label address B
  cmpq %rcx, %rdx
  je .L.cmpdtypes.149.true # jump if match
  cmpq $0, %rdx # check if A is nil
  je .L.cmpdtypes.149.false # jump if nil
  cmpq $0, %rcx # check if B is nil
  je .L.cmpdtypes.149.false # jump if nil
  jmp .L.cmpdtypes.149.cmp # jump to end
  .L.cmpdtypes.149.true:
  pushq $1
  jmp .L.cmpdtypes.149.end # jump to end
  .L.cmpdtypes.149.false:
  pushq $0
  jmp .L.cmpdtypes.149.end # jump to end
  .L.cmpdtypes.149.cmp:
  subq $8, %rsp # alloc return vars area
  ...
  popq %rax # result of  indexvar < lenvar
  cmpq $1, %rax
  jne .L.range.exit.151 # jmp if false
  ...
  popq %rax # result of  indexvar < lenvar
  cmpq $1, %rax
  jne .L.range.exit.153 # jmp if false
